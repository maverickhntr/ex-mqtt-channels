...
//This sets an active listener which will eventually populate the channelsReceived array
//everytime we have an incoming message
...
setTimeout(function(){
  ...
  //console.log("channelsReceived size: " + ex.channelsReceived.length);
